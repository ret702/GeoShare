...
class ChildAdapter extends RecyclerView.Adapter<ChildAdapter.ChildViewHolder> {
    ...
    public void onBindViewHolder(ChildViewHolder childViewHolder, int i) {
        ...
        if (urls.get(i).getString("title") != null) {
            childViewHolder.titleTextView.setVisibility(View.INVISIBLE);
            childViewHolder.titleTextView.setBackground(new ColorDrawable(0xFFFFFF));
        } else {
            childViewHolder.titleTextView.setText(urls.get(i).getString("title"));
        }
